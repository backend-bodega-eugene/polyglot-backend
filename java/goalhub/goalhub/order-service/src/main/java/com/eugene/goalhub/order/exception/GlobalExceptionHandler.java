package com.eugene.goalhub.order.exception;
...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleBusinessException(BusinessException e) {
        goalhubLogService.errLog("order-service", "BUSINESS_EXCEPTION", e);
    ...
    public Result<Void> handleException(Exception e) {
        goalhubLogService.sysLog(
                ...
                "order-service 发生未预期异常"
        );
        goalhubLogService.errLog("order-service", "UNEXPECTED_EXCEPTION", e);
