...
/**
 * 游戏抽奖算法 alias method
 * 算法原理：https://www.keithschwarz.com/darts-dice-coins/
 */
public class AliasMethodUtils {
     ...
     */
    public AliasMethodUtils(List<Double> probabilities) {
     ...
     */
    public AliasMethodUtils(List<Double> probabilities, Random random) {
    ...
    public static void main(String[] args) {
        ...
        AliasMethodUtils method = new AliasMethodUtils(list);
